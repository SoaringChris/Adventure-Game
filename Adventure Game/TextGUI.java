...

{
	...
	public static double roomNum = 12;
	public static String playerName;
	public static boolean hasKey1 = false;
	public static boolean hasgoldenkey = false;
	public static boolean hasgoldensword = false;
	public static boolean hassigil = false;
	...
	public TextGUI()
	{
		...
		game.requestFocus(true);
		 ...
		 //This is the output box, black background, white text, cannot be typed into ect.
		gamePanel.add(game, BorderLayout.SOUTH);
		JTextArea gameLabel = new JTextArea("Welcome to the Dungeon of death, destruction, and donuts(not really), you have been sent by your doubtful father, to defeat the Orc king in the deep caves of Na'Gul", 5, 20);
		gameLabel.setLineWrap(true);
		gameLabel.setText(gameLabel.getText() + "\n I am Galio the gaurdina of this cave, please tell me your name.");
