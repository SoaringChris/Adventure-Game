public class room6
{
	...
	public static void main (String[] args)
	{
		...
		else if(TextGUI.game.getText().equals("pull out cobblestone") || TextGUI.game.getText().equals("pull out the stone") || TextGUI.game.getText().equals("pull out the brick") && cobblefound == true)
					{
