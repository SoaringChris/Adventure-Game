public class room9
{
	...
	public static void main (String[] args)
	{
		...
		else if(TextGUI.game.getText().equals("put back yellow") || TextGUI.game.getText().equals("take yellow") && yellow == false)
		{
			...
			{
				TextGUI.area.setText(TextGUI.area.getText() + "\n you burn down the vines and you go through the north door. in this room you see a large chest in the middle of the room, you approach the chest and sees that it has an inscription on it, it reads \" you have come far in this dungeon, but your greatest challenge is yet to come. i have left these things here in hopes that a hero other than i could best this dungeon, so please take what is in this chest \"");
				TextGUI.roomNum = 13;
			}
		else
		{
