public class room5
{
	...
	public static void main (String[] args)
	{
		...
		{
			TextGUI.area.setText(TextGUI.area.getText() + "you insert the three keys into the door, and it opens on its own. you walk into a room with a white light being shone on a crystal with a tile under it colored a dark blue. there are 3 pieces of colored glass next to the source of the light. one yellow, one magenta, and one cyan. there is a door to the north that is covered in thick vines, what do you do?");
			TextGUI.roomNum = 9;
		}
		...
		{
		usingtiles = true;
		TextGUI.area.setText(TextGUI.area.getText() + "you begin using the tiles");
		}
