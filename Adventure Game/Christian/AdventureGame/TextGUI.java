...

{
	...
	public static double roomNum = 16;
	...
	public TextGUI()
	{
		...
		super("Great Galio's Cave of Secrets");
		...
		JTextArea gameLabel = new JTextArea("Welcome to the Dungeon of death, destruction, and donuts(not really), you have been sent by your doubtful father, to defeat the demon king in the deep caves of Na'Gul", 5, 20);
