public class room11
{
	...
	public static void main (String[] args)
	{
		...
		if(solved == false)
		{
			...
			{
				if(TextGUI.game.getText().equals("examine shiny thing")&& room5.haskey2 == false)
						TextGUI.area.setText(TextGUI.area.getText() + "\nIt's a key!");
				...
				{
					TextGUI.roomNum = 12;
					TextGUI.area.setText(TextGUI.area.getText() + "\nyou walk into the next room and see a chest on a pedestal. what do you do?");
				}
				else if(TextGUI.game.getText().equals("go west"))
				{
					TextGUI.roomNum = 10;
					TextGUI.area.setText(TextGUI.area.getText() + "\nYou go back into the room with the potions, the walls are still down from before");
				}
				else if(TextGUI.game.getText().equals("look around"))
