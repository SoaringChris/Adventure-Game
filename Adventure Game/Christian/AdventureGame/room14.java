public class room14
{
	...
	{
		if(TextGUI.game.getText().equals("examine door"))
		TextGUI.area.setText(TextGUI.area.getText() + "\nyou look at the first image next to the door. it shows a man sideways, with his arms up and his hands looking like claws. it also shows a mirror image of him with arrows in between the 2, showing that you would turn during the dance, what kind of dance do you do?");
		
		else if(TextGUI.game.getText().equals("thriller")||TextGUI.game.getText().equals("do the thriller"))
		{
		...
		else if(TextGUI.game.getText().equals("moonwalk") || TextGUI.game.getText().equals("do the moonwalk") && thriller == true)
		{
		...
		else if(TextGUI.game.getText().equals("funky chicken") || TextGUI.game.getText().equals("do the funky chicken") && thriller == true && moonwalk == true)
		{
		...
		else if(TextGUI.game.getText().equals("gangnam style") || TextGUI.game.getText().equals("do gangnam style") && thriller == true && moonwalk == true && funkychicken == true)
		{
		...
		else if(TextGUI.game.getText().equals("hammertime") || TextGUI.game.getText().equals("do hammertime") || TextGUI.game.getText().equals("mc hammer") && thriller == true && moonwalk == true && funkychicken == true && gangnamstyle == true)
		{
		...
		else if(TextGUI.game.getText().equals("single ladies") || TextGUI.game.getText().equals("dance single ladies") || TextGUI.game.getText().equals("beyonce") && thriller == true && moonwalk == true && funkychicken == true && gangnamstyle == true && hammertime == true)
		{
		...
		else if(TextGUI.game.getText().equals("sprinkler") || TextGUI.game.getText().equals("do the sprinkler") && thriller == true && moonwalk == true && funkychicken == true && gangnamstyle == true && hammertime == true && singleladies == true)
		{
		...
		else if(TextGUI.game.getText().equals("cooking") || TextGUI.game.getText().equals("do the cooking dance") && thriller == true && moonwalk == true && funkychicken == true && gangnamstyle == true && hammertime == true && singleladies == true && sprinkler == true)
		{
		...
		else if(TextGUI.game.getText().equals("macarena") || TextGUI.game.getText().equals("do the macarena") && thriller == true && moonwalk == true && funkychicken == true && gangnamstyle == true && hammertime == true && singleladies == true && sprinkler == true && cooking == true)
		{
		...
		else if(TextGUI.game.getText().equals("go east") && thriller == true && moonwalk == true && funkychicken == true && gangnamstyle == true && hammertime == true && singleladies == true && sprinkler == true && cooking == true && macarena == true)
		{
