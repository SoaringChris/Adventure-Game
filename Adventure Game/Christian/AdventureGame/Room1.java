	...
	public static void main (String[] args)
{
	if(TextGUI.hasKey1 == true)
	{
		...
		if(TextGUI.game.getText().equals("go north") && muralfixed == false)
		{
		...
		else if(TextGUI.game.getText().equals("examine bookcase"))
			TextGUI.area.setText(TextGUI.area.getText() + "\nIt's set firmly in place. There are many scattered pages of broken books around its base, all read nothing, however one book still remains upright at a perfect ninty degree angle.");
		else
			TextGUI.area.setText(TextGUI.area.getText() + "\nI don't know what your trying to do, try asking for help if you need some suggestions.");
		}
