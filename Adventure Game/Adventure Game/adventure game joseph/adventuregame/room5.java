public class room5
{
	...
	public static void main (String[] args)
	{
		...
		else if(TextGUI.game.getText().equals("put keys in door")||TextGUI.game.getText().equals("go north")|| TextGUI.game.getText().equals("open door") && haskey1 == true && haskey2 == true && haskey3 == true)
		{
			TextGUI.area.setText(TextGUI.area.getText() + "you insert the 3 keys into the the door and turn them, the door lifts, revealing the next room. what do you do?");
			if(TextGUI.game.getText().equals("go north")|| TextGUI.game.getText().equals("go through door"))
			{
				TextGUI.area.setText(TextGUI.area.getText() + "you go through the opening into the next room. to the north there is a door that is covered by thick vines, it does not seem openable. \nto the east there is another locked door \n there is a white light being shone on a crystal aboce the east door. the crystal has a dark blue tile under it. the white light has 3 colored peices of glass next to it. one yellow, one, magenta, and one cyan");
				TextGUI.roomNum = 9;
			}
		}
