public class room7
{
	...
	public static void main (String[] args)
	{
		...
		if(attempting == false)
		{
			if(solved == false)
			{
				if(TextGUI.game.getText().equals("solve puzzle"))
						{
							attempting = true;
			...
			else if(TextGUI.game.getText().equals("go east")||TextGUI.game.getText().equals("open east door"))
		{
			if(solved == true)
			{
				TextGUI.area.setText(TextGUI.area.getText() +"\nYou pass into the next room, there is nothing here, the walls are uniform and there are no doors except for the one you came in. \n this saddens you because it seems you will never find the third key and all of those solved puzzles were for naught. \n what do you do?");
				TextGUI.roomNum = 8;
			...
			{
				TextGUI.area.setText(TextGUI.area.getText() + "\n you go back into the room with the colored tiles, still depressed from your last visit");
				TextGUI.roomNum = 6;
